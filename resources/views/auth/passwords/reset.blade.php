...
<head>
    ...
    <title>Restablecer Contraseña | OrgTrack</title>
        ...
        <div class="card-body login-card-body">
            ...
            <form action="{{ route('password.update') }}" method="post">
                ...
                <div class="input-group mb-3">
                    <input type="email" name="email" class="form-control @error('email') is-invalid @enderror" placeholder="Email" value="{{ $email ?? old('email') }}" required autofocus>
